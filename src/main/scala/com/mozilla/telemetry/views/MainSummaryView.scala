...
object MainSummaryView {
  ...
  def buildSchema(userPrefs: List[UserPref], scalarDefinitions: List[(String, ScalarDefinition)], histogramDefinitions: List[(String, HistogramDefinition)]): StructType = {
    StructType(List(
      ...
      StructField("cpu_cores", IntegerType, nullable = true),
      StructField("cpu_vendor", StringType, nullable = true),
      StructField("cpu_family", IntegerType, nullable = true),
      StructField("cpu_model", IntegerType, nullable = true),
      StructField("cpu_stepping", IntegerType, nullable = true),
      StructField("cpu_l2_cache_kb", IntegerType, nullable = true),
      StructField("cpu_l3_cache_kb", IntegerType, nullable = true),
      StructField("cpu_speed_mhz", IntegerType, nullable = true),

      StructField("gfx_features_d3d11_status", StringType, nullable = true),
      StructField("gfx_features_d2d_status", StringType, nullable = true),
      StructField("gfx_features_gpu_process_status", StringType, nullable = true),
      StructField("gfx_features_advanced_layers_status", StringType, nullable = true),
